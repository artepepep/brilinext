export default function SpriteSVG ({ name }: { name: string }) {
  switch (name) {
    ...
    case "backArrow":
      return (
        <svg className={"stroke-black dark:stroke-white"} width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M13.75 16.5L8.25 11L13.75 5.5" />
        </svg>
