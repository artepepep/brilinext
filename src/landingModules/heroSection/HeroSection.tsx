      ...
      <Container>
        <div className="py-10 flex min-h-fit flex-col gap-6 md:max-w-[704px] xl:max-w-[1064px]">
          ...
          <div className="xl:mt-5">
            <GradientButton type="link" href="/#whatWeCanDo" text="Contact us" uppercase={false} />
          </div>
        </div>
        <div className="hidden md:block"><Blob small={false} styles={"top-[-200px] right-[-200px]"} /></div>
