...
import {ApplicationTypes, HeroSection, DevelopmentProcess, SuccessStories} from "@/industriesModules";
  ...
  return (
    <main className={"scroll-smooth"}>
      ...
      <HeroSection
        ...
        paragraphs={["Shopping isn't what it used to be. Forget the crowded malls and limited hours. E-commerce has exploded in popularity, offering a shopping experience that's tailored to today's busy consumer. With just a few clicks, you can browse millions of products, compare prices with ease, and have your purchases delivered straight to your door. It's no wonder e-commerce is on the rise! But what exactly is driving this trend, and how can businesses capitalize on this massive shift in consumer behavior?",
