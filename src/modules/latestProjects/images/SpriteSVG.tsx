export default function SharedSpriteSVG ({ name }: { name: string }) {
  switch (name) {
    case "prevButton":
      return (
        <svg className="stroke-black dark:stroke-[#D9D9D9] hover:stroke-[#F10BD0] dark:hover:stroke-[#F10BD0]" width="32" height="13" viewBox="0 0 32 13" fill="none" xmlns="http://www.w3.org/2000/svg">
